...
const Folder = ({
  ...
  const paper1 = isDark
    ? darkenColor("#ffff", 0.1)
    : darkenColor("#ffffff", 0.1);
  const paper2 = isDark
    ? darkenColor("#ffff", 0.05)
    : darkenColor("#ffffff", 0.05);
  const paper3 = isDark ? "#ffff" : "#ffffff";
        ...
        >
          ...
          {papers.map((item, i) => {
            ...
            return (
              ...
              >
                {/* Wrap logo in a span to apply dark mode filter */}
                {item && (
                  <span className="flex items-center justify-center w-full h-full dark:invert dark:brightness-75">
                    {item}
                  </span>
                )}
              </div>
